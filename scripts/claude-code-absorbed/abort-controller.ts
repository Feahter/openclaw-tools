 ...
 * Original: src/utils/abortController.ts
 * 
 * Memory-safe AbortController with parent-child propagation.
 * Uses WeakRef so abandoned children can be GC'd.
 */
 ...
 * Child aborting does NOT affect the parent.
 * Memory-safe: WeakRef prevents parent from retaining abandoned children.
 */
